<script lang="ts">
	...
	onMount(async () => {
		...
		try{
            original = await ComisionService.obtenerComisionOrganizacionCompleta(id);
...
<PopupError bind:visible={errorPermiso}>
	No tiene permiso para modificar Comisiones por Organización.
</PopupError>

<Popup bind:visible={exitoVisible} fitH fitW>
	<span>
        Comisión por Organización modificada exitosamente. 
    </span>
