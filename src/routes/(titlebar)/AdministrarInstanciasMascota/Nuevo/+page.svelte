...
<div id="content">
	<div class="p-2 text-xs flex flex-col gap-2 overflow-y-auto grow md:grow-0">
		<h1 class="text-m text-center md:text-start">Nueva Instancia de Mascota</h1>
...
<PopupError bind:visible={errorPermiso}>
	No tiene permiso para dar de alta instancias de mascota.
</PopupError>

<Popup bind:visible={exitoVisible} fitH fitW>
	<span>
        Instancia de mascota añadida exitosamente. 
    </span>
